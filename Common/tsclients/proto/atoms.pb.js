...
export const Event = {
  ...
  _writeMessage: function(msg, writer) {
    ...
    if (msg.allowManualAddReplay) {
      writer.writeBool(18, msg.allowManualAddReplay);
    }
    return writer;
  },
  /**
...
export const Penalty = {
  ...
  _writeMessage: function(msg, writer) {
    ...
    if (msg.cancellationReason != void 0) {
...
export const RegisteredPlayer = {
  ...
  _writeMessage: function(msg, writer) {
    ...
    if (msg.majsoulId != void 0) {
      writer.writeInt32(10, msg.majsoulId);
    }
    if (msg.majsoulNickname != void 0) {
...
export const SessionState = {
  ...
  _writeMessage: function(msg, writer) {
    ...
    if (msg.chombo?.length) {
      writer.writeRepeatedMessage(9, msg.chombo, Chombo._writeMessage);
    }
    return writer;
  },
  /**
...
export const EventJSON = {
  ...
  _readMessage: function(msg, json) {
    ...
    const _tournamentStarted_ = json["tournamentStarted"] ?? json["tournament_started"];
    ...
    const _achievementsShown_ = json["achievementsShown"] ?? json["achievements_shown"];
    ...
    const _allowManualAddReplay_ = json["allowManualAddReplay"] ?? json["allow_manual_add_replay"];
...
export const GameConfigJSON = {
  ...
  _readMessage: function(msg, json) {
    ...
    const _eventDescription_ = json["eventDescription"] ?? json["event_description"];
    ...
    const _allowPlayerAppend_ = json["allowPlayerAppend"] ?? json["allow_player_append"];
    ...
    const _hideAddReplayButton_ = json["hideAddReplayButton"] ?? json["hide_add_replay_button"];
    ...
    const _allowViewOtherTables_ = json["allowViewOtherTables"] ?? json["allow_view_other_tables"];
...
export const PlayerInRatingJSON = {
  ...
  _readMessage: function(msg, json) {
    ...
    const _penaltiesAmount_ = json["penaltiesAmount"] ?? json["penalties_amount"];
...
export const PenaltyJSON = {
  ...
  _readMessage: function(msg, json) {
    ...
    const _cancellationReason_ = json["cancellationReason"] ?? json["cancellation_reason"];
...
export const SeriesResultJSON = {
  ...
  _readMessage: function(msg, json) {
    ...
    const _bestSeriesScores_ = json["bestSeriesScores"] ?? json["best_series_scores"];
    if (_bestSeriesScores_) {
      msg.bestSeriesScores = protoscript.parseDouble(_bestSeriesScores_);
    }
    const _bestSeriesPlaces_ = json["bestSeriesPlaces"] ?? json["best_series_places"];
    if (_bestSeriesPlaces_) {
      msg.bestSeriesPlaces = protoscript.parseNumber(_bestSeriesPlaces_);
    }
    const _bestSeriesAvgPlace_ = json["bestSeriesAvgPlace"] ?? json["best_series_avg_place"];
    ...
    const _currentSeriesScores_ = json["currentSeriesScores"] ?? json["current_series_scores"];
    if (_currentSeriesScores_) {
      msg.currentSeriesScores = protoscript.parseDouble(_currentSeriesScores_);
    }
    const _currentSeriesPlaces_ = json["currentSeriesPlaces"] ?? json["current_series_places"];
    if (_currentSeriesPlaces_) {
      msg.currentSeriesPlaces = protoscript.parseNumber(_currentSeriesPlaces_);
    }
    const _currentSeriesAvgPlace_ = json["currentSeriesAvgPlace"] ?? json["current_series_avg_place"];
...
export const RegisteredPlayerJSON = {
  ...
  _readMessage: function(msg, json) {
    ...
    const _majsoulNickname_ = json["majsoulNickname"] ?? json["majsoul_nickname"];
...
export const PlayerWinSummaryJSON = {
  ...
  _readMessage: function(msg, json) {
    ...
    const _unforcedFeedToOpen_ = json["unforcedFeedToOpen"] ?? json["unforced_feed_to_open"];
    if (_unforcedFeedToOpen_) {
      msg.unforcedFeedToOpen = protoscript.parseNumber(_unforcedFeedToOpen_);
    }
    const _unforcedFeedToRiichi_ = json["unforcedFeedToRiichi"] ?? json["unforced_feed_to_riichi"];
    if (_unforcedFeedToRiichi_) {
      msg.unforcedFeedToRiichi = protoscript.parseNumber(
        _unforcedFeedToRiichi_
      );
    }
    const _unforcedFeedToDama_ = json["unforcedFeedToDama"] ?? json["unforced_feed_to_dama"];
    ...
    const _pointsLostTsumo_ = json["pointsLostTsumo"] ?? json["points_lost_tsumo"];
...
export const RiichiSummaryJSON = {
  ...
  _readMessage: function(msg, json) {
    ...
    const _feedUnderRiichi_ = json["feedUnderRiichi"] ?? json["feed_under_riichi"];
...
export const TableStateJSON = {
  ...
  _readMessage: function(msg, json) {
    ...
    const _currentRoundIndex_ = json["currentRoundIndex"] ?? json["current_round_index"];
...
export const AchievementJSON = {
  ...
  _readMessage: function(msg, json) {
    ...
    const _achievementData_ = json["achievementData"] ?? json["achievement_data"];
...
export const RulesetConfigJSON = {
  ...
  _readMessage: function(msg, json) {
    ...
    const _doubleronHonbaAtamahane_ = json["doubleronHonbaAtamahane"] ?? json["doubleron_honba_atamahane"];
    if (_doubleronHonbaAtamahane_) {
      msg.doubleronHonbaAtamahane = _doubleronHonbaAtamahane_;
    }
    const _doubleronRiichiAtamahane_ = json["doubleronRiichiAtamahane"] ?? json["doubleron_riichi_atamahane"];
    ...
    const _extraChomboPayments_ = json["extraChomboPayments"] ?? json["extra_chombo_payments"];
    if (_extraChomboPayments_) {
      msg.extraChomboPayments = _extraChomboPayments_;
    }
    const _playAdditionalRounds_ = json["playAdditionalRounds"] ?? json["play_additional_rounds"];
    if (_playAdditionalRounds_) {
      msg.playAdditionalRounds = _playAdditionalRounds_;
    }
    const _riichiGoesToWinner_ = json["riichiGoesToWinner"] ?? json["riichi_goes_to_winner"];
    ...
    const _withKiriageMangan_ = json["withKiriageMangan"] ?? json["with_kiriage_mangan"];
    ...
    const _withLeadingDealerGameOver_ = json["withLeadingDealerGameOver"] ?? json["with_leading_dealer_game_over"];
    if (_withLeadingDealerGameOver_) {
      msg.withLeadingDealerGameOver = _withLeadingDealerGameOver_;
    }
    const _withMultiYakumans_ = json["withMultiYakumans"] ?? json["with_multi_yakumans"];
    if (_withMultiYakumans_) {
      msg.withMultiYakumans = _withMultiYakumans_;
    }
    const _withNagashiMangan_ = json["withNagashiMangan"] ?? json["with_nagashi_mangan"];
    if (_withNagashiMangan_) {
      msg.withNagashiMangan = _withNagashiMangan_;
    }
    const _withWinningDealerHonbaSkipped_ = json["withWinningDealerHonbaSkipped"] ?? json["with_winning_dealer_honba_skipped"];
    ...
    const _gameExpirationTime_ = json["gameExpirationTime"] ?? json["game_expiration_time"];
    ...
    const _replacementPlayerFixedPoints_ = json["replacementPlayerFixedPoints"] ?? json["replacement_player_fixed_points"];
    if (_replacementPlayerFixedPoints_) {
      msg.replacementPlayerFixedPoints = protoscript.parseNumber(
        _replacementPlayerFixedPoints_
      );
    }
    const _replacementPlayerOverrideUma_ = json["replacementPlayerOverrideUma"] ?? json["replacement_player_override_uma"];
    ...
    const _yakitoriPenalty_ = json["yakitoriPenalty"] ?? json["yakitori_penalty"];

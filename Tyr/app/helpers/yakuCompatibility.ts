...
const combinableYakumans = [
  ...
  [Y.SUUANKOUTANKI, Y.DAISANGEN],
  [Y.SUUANKOUTANKI, Y.SHOSUUSHII],
  [Y.SUUANKOUTANKI, Y.DAISUUSHII],
  [Y.SUUANKOUTANKI, Y.TSUUIISOU],
  [Y.SUUANKOUTANKI, Y.CHINROTO],
  [Y.SUUANKOUTANKI, Y.RYUUIISOU],
  [Y.SUUANKOUTANKI, Y.TENHOU],
  [Y.SUUANKOUTANKI, Y.CHIHOU],
  ...
  [Y.CHUURENPOUTOPURE, Y.TENHOU],
  [Y.CHUURENPOUTOPURE, Y.CHIHOU],
  ...
  [Y.KOKUSHIMUSOU13, Y.TENHOU],
  [Y.KOKUSHIMUSOU13, Y.CHIHOU],

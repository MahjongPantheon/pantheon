...
export type TemplaiScreenViewProps = {
  topPlayer: TemplaiScreenPlayer;
  leftPlayer: TemplaiScreenPlayer;
  rightPlayer: TemplaiScreenPlayer;
  bottomPlayer: TemplaiScreenPlayer;
...
export const TemplaiScreenView: React.FC<TemplaiScreenViewProps> = (props) => {
  const {
    topPlayer,
    leftPlayer,
    rightPlayer,

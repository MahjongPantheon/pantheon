...
export async function up(db: Kysely<any>): Promise<void> {
  ...
  await db.schema.createIndex('person_country').on('person').column('country').execute();

  await db.schema.createIndex('person_disabled').on('person').column('disabled').execute();

  await db.schema.createIndex('person_email').on('person').column('email').execute();

  await db.schema.createIndex('person_title').on('person').column('title').execute();
  ...
  await db.schema.createIndex('registrant_email').on('registrant').column('email').execute();

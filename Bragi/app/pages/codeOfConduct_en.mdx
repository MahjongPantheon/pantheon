...
- Pantheon as a service:
  - Pantheon has default installation at **riichimahjong.org**.
  - The riichimahjong.org site is supported directly by it's developers team.
  - Anyone can create new tournament or local rating after the registration in system.
  ...
  - Pantheon is GDPR-compliant. You can remove your account any time you want and all your personal data will be removed.
    Results of already played games will stay in the system but will be depersonalized.
  - Pantheon main instance is hosted in Nuremberg, Germany, so all the data processed must comply to EU regulations. If you witness any violations, please contact the service administrator.
</section>

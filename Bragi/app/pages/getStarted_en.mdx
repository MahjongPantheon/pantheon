...
At first you should щтсу [register in the system](https://manage.riichimahjong.org/profile/signup). You will need a
...
- Please, do not register twice. If there is an account registered to your e-mail, but you don't remember the password,
  please use [password recovery page](https://manage.riichimahjong.org/profile/resetPassword).
...
under menu button). Also you can get directly to the [mobile assistant](https://assist.riichimahjong.org) and log in
...
- [Mobile assistant instructions](/forPlayers)
- [Administration panel instructions](/forHosts)

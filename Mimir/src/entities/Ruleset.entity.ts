...
export class RulesetEntity {
  ...
  static createRuleset(baseRuleset: RulesetEntity['baseRuleset']): RulesetEntity {
    switch (baseRuleset) {
      case 'ema':
        return new RulesetEntity(baseRuleset, 'European Mahjong Association rules', {
      ...
      case 'jpmlA':
        return new RulesetEntity(baseRuleset, 'Japanese Professional Mahjong League A rules', {
          complexUma: {
            neg3: {
              place1: 12000,
              place2: -1000,
      ...
      case 'wrc':
        return new RulesetEntity(baseRuleset, 'World Riichi Championship rules', {
          complexUma: {} as ComplexUma, // TODO: make optional
          endingPolicy: EndingPolicy.ENDING_POLICY_EP_END_AFTER_HAND,
          uma: { place1: 15000, place2: 5000, place3: -5000, place4: -15000 },
          umaType: UmaType.UMA_TYPE_UMA_SIMPLE,
      ...
      case 'tenhounet':
        return new RulesetEntity(baseRuleset, 'Tenhou.net compatible rules', {
          complexUma: {} as ComplexUma, // TODO: make optional
      ...
      case 'rrc':
        return new RulesetEntity(baseRuleset, 'Russian Riichi Community rules', {
          complexUma: {} as ComplexUma, // TODO: make optional
          endingPolicy: EndingPolicy.ENDING_POLICY_EP_ONE_MORE_HAND,
          uma: { place1: 15000, place2: 5000, place3: -5000, place4: -15000 },
          umaType: UmaType.UMA_TYPE_UMA_SIMPLE,
  ...
  equalizedUma(scores: number[], uma: number[]): number[] {
  ...
  getUma(scores: number[]): number[] {
    let uma: number[];
    if (this.rules.umaType === UmaType.UMA_TYPE_UMA_COMPLEX) {
      uma = this.complexUma(
        scores,
        {
          3: [
            this.rules.complexUma.neg3.place1,
            this.rules.complexUma.neg3.place2,
            this.rules.complexUma.neg3.place3,
            this.rules.complexUma.neg3.place4,
          ],
          1: [
            this.rules.complexUma.neg1.place1,
            this.rules.complexUma.neg1.place2,
            this.rules.complexUma.neg1.place3,
            this.rules.complexUma.neg1.place4,
          ],
          default: [
            this.rules.complexUma.otherwise.place1,
            this.rules.complexUma.otherwise.place2,
            this.rules.complexUma.otherwise.place3,
            this.rules.complexUma.otherwise.place4,
          ],
        },
        this.rules.startPoints
      );
    } else {
      uma = [
        this.rules.uma.place1,
        this.rules.uma.place2,
        this.rules.uma.place3,
        this.rules.uma.place4,
      ];
    }

    if (this.rules.equalizeUma) {
      return this.equalizedUma(scores, uma);
    }

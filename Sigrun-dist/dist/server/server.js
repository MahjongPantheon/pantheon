...
const meta = {
  ...
  reportMsgidBugsTo: "",
  potCreationDate: "2023-05-27 18:40+0300",
  poRevisionDate: "2023-05-27 19:10+0300",
  languageTeam: "",
  language: "ru",
  mimeVersion: "1.0",
        ...
        if (!resp.ok) {
          return resp.json().then((err) => {
            ...
            if (err.code && err.code === "internal" && err.meta && err.meta.cause) {
              (_a = this._analytics) == null ? void 0 : _a.track(Analytics.REMOTE_ERROR, {
                url,
  ...
  return rounds.map((round) => {
    ...
    if (round.ron) {
      return i18n2._pt("Ron log item", "%1: <b>%2</b> - %3 (<b>%4</b>), %5. Riichi bets: %6", [
        ...
        makeCsvPlayers(players, round.ron.riichiBets) || i18n2._t("none")
      ]);
    }
    if (round.tsumo) {
      return i18n2._pt("Tsumo log item", "%1: <b>%2</b> - %3 (tsumo), %4. Riichi bets: %5", [
        ...
        makeCsvPlayers(players, round.tsumo.riichiBets) || i18n2._t("none")
      ]);
    }
    if (round.draw) {
      return i18n2._pt("Draw log item", "%1: Exhaustive draw (tenpai: %2). Riichi bets: %3", [
        ...
        makeCsvPlayers(players, round.draw.riichiBets) || i18n2._t("none")
      ]);
    }
    if (round.abort) {
      return i18n2._pt("Abortive draw log item", "%1: Abortive draw. Riichi bets: %2", [
        makeRound(round.abort.roundIndex),
        makeCsvPlayers(players, round.abort.riichiBets) || i18n2._t("none")
      ]);
    }
    if (round.chombo) {
    ...
    if (round.nagashi) {
      return i18n2._pt("Nagashi log item", "%1: Nagashi mangan (<b>%2</b>). Riichi bets: %3", [
        ...
        makeCsvPlayers(players, round.nagashi.riichiBets) || i18n2._t("none")
      ]);
    }
    if (round.multiron) {
      ...
      return i18n2._pt("Multiron outer log item", "%1: Ron (<b>%2</b>). Riichi bets: %3", [
        ...
        makeCsvPlayers(players, round.multiron.riichiBets) || i18n2._t("none")
      ]) + list;
    }
    return "";
  });

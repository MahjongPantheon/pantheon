...
const _Analytics = class {
  ...
  static startup() {
    if (navigator.appVersion.includes("Win"))
      _Analytics.OSName = "Windows";
    if (navigator.appVersion.includes("Mac"))
      _Analytics.OSName = "MacOS";
    if (navigator.appVersion.includes("X11"))
      _Analytics.OSName = "UNIX";
    if (navigator.appVersion.includes("Linux"))
      _Analytics.OSName = "Linux";
    _Analytics.sessionId = v4();
    _Analytics.isTablet = false;
    (function(a) {
  ...
  _trackViewEvent(url) {
    ...
    const payload = {
      s: this._siteId,
      si: _Analytics.sessionId,
      h: window.location.hostname,
      o: _Analytics.OSName,
      d: _Analytics.isTablet ? "tablet" : _Analytics.isMobile ? "mobile" : "desktop",
...
__publicField(Analytics, "OSName", "Unknown OS");
__publicField(Analytics, "sessionId");
__publicField(Analytics, "isTablet", false);
__publicField(Analytics, "isMobile", false);
class ApiService {
